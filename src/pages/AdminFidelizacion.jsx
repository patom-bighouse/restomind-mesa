...
export default function AdminFidelizacion() {
  ...
  if (!tieneModulo('marketing_fidelizacion')) {
    return (
      <div style={S.app}>
        <div style={S.header}>
          <div>
        ...
        <div style={S.content}>
          <div style={S.sectionTitle}>Fidelización</div>
          <div style={S.sectionHint}>Este restaurante no tiene activo el módulo de marketing y fidelización.</div>
        </div>
      </div>
    )
  }
    ...
    <div style={S.app}>
      ...
      <div style={S.header}>
        ...
        <div style={S.navTabs}>
          ...
          {tieneModulo('marketing_fidelizacion') && <a href={`/admin/fidelizacion/${restaurantId}`} style={S.navTab(true)}>Fidelización</a>}
