    ...
    return (
      <div style={S.app}>
        ...
        <div style={S.content}>
          ...
          <div style={S.sectionHint}>Este restaurante no tiene activo el módulo de multi-menú.</div>
        </div>
      </div>
    )
  }
    ...
    <div style={S.app}>
      ...
      <div style={S.header}>
        ...
        <div style={S.navTabs}>
          ...
          {tieneModulo('multi_menu') && <a href={`/admin/menus/${restaurantId}`} style={S.navTab(true)}>Menús</a>}
