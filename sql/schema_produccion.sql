...
\restrict lJcUKl7KB8OV9wTQ94VwAEEXyG7MCqhGpGrMpvg9jmgj93bGHFPpR9EyXKGaPSz
...
--
-- Name: objects actualizacion autenticada menu-images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "actualizacion autenticada menu-images" ON storage.objects FOR UPDATE USING (((bucket_id = 'menu-images'::text) AND (auth.role() = 'authenticated'::text)));
...
--
-- Name: objects eliminacion autenticada menu-images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "eliminacion autenticada menu-images" ON storage.objects FOR DELETE USING (((bucket_id = 'menu-images'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects lectura publica menu-images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "lectura publica menu-images" ON storage.objects FOR SELECT USING ((bucket_id = 'menu-images'::text));
...
--
-- Name: objects owner_delete_menu_images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY owner_delete_menu_images ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'menu-images'::text) AND public.is_restaurant_owner(((storage.foldername(name))[1])::uuid)));


--
-- Name: objects owner_update_menu_images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY owner_update_menu_images ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'menu-images'::text) AND public.is_restaurant_owner(((storage.foldername(name))[1])::uuid)));


--
-- Name: objects owner_upload_menu_images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY owner_upload_menu_images ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'menu-images'::text) AND public.is_restaurant_owner(((storage.foldername(name))[1])::uuid)));


--
-- Name: objects public_read_menu_images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY public_read_menu_images ON storage.objects FOR SELECT USING ((bucket_id = 'menu-images'::text));
...
--
-- Name: objects subida autenticada menu-images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "subida autenticada menu-images" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'menu-images'::text) AND (auth.role() = 'authenticated'::text)));
...
--
-- Name: supabase_realtime categories; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime menu_items; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime table_session_payments; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.table_session_payments;


--
-- Name: supabase_realtime table_sessions; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime waiter_calls; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.waiter_calls;
...
\unrestrict lJcUKl7KB8OV9wTQ94VwAEEXyG7MCqhGpGrMpvg9jmgj93bGHFPpR9EyXKGaPSz
